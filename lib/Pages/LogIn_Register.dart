  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Padding(
        ...
        child: Card(
          child: ListTile(
              leading: Icon(Icons.account_circle), title:TextField(
      ...
      Padding(
        padding: const EdgeInsets.symmetric(horizontal: 8.0),
        child: Card(
          child: ListTile(leading: Icon(Icons.email), title: TextField(
                decoration: InputDecoration(
                  hintText: "Email"
                ),
              ),),
       ...
       Padding(
        padding: const EdgeInsets.symmetric(horizontal: 8.0),
        child: Card(
          child: ListTile(leading: Icon(Icons.lock), title: TextField(
                decoration: InputDecoration(
                  hintText: "Password"
                ),
              ),),
